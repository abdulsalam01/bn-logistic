    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="my-3">
                    <a href="<?= base_url('admin/branch/create') ?>">
                            ...
                            <tbody>
                                <?php foreach ($model['data'] as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td><?= $value['name'] ?></td>
                                        <td><?= $value['address'] ?></td>
                                        <td><?= $value['call_center'] ?></td>
                                        <td><?= $value['longitude'] . ',' . $value['latitude'] ?></td>
                                        <td><?= $value['created_at'] ?></td>
                                        <td>
                                            <a href="<?= base_url('admin/branch/edit/' . md5($value['id'])) ?>">
                                                <button type="button" class="btn btn-primary btn-sm rounded-pill">Edit</button>
                                            </a>
                                            <form action="<?= base_url('admin/branch/delete/' . md5($value['id'])) ?>" method="delete">

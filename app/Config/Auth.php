...
class Auth extends ShieldAuth
{
    ...
    public array $redirects = [
        // 'register' => '/register/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IkJOLUxvZ2lzdGljIiwicGFzc3dvcmQiOiJibi1sb2dpc3RpYyJ9.A3sxCRe4yv50oAYg_gDUqB10FyJ0CWPFyfeyvM3lhyk',
        'login'    => '/admin',
        'logout'   => '/login',
    ];

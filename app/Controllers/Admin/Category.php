...
class Category extends BaseController
{
    ...
    {
        $this->data['title'] = $this->baseTitle . 'Category';
        $this->data['model'] = [
    ...
    {
        $this->data['title'] = $this->baseTitle . 'Create Category';
    ...
    public function edit($id)
    {
        ...
        $this->data['title'] = $this->baseTitle . 'Update Category';
